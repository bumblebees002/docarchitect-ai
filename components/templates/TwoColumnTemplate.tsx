...
const TwoColumnTemplate: React.FC<Props> = ({ data, theme, isMini = false, onUpdate }) => {
    ...
    >
      ...
      <div className="flex p-8 gap-8">
        ...
        <div className="flex-1">
          <h1 className="text-[36pt] font-bold mb-4" style={{ color: themeColor }}>
        ...
        <div className="relative group no-print">
          <div className="w-32 h-32 rounded-full bg-slate-200 overflow-hidden border-4" style={{ borderColor: themeColor }}>
            {p.profilePicture ? (
      ...
      <div className="flex px-8 pb-8 gap-8">
        ...
        <div className="flex-1">
          ...
          <section className="mb-8">
            <h2 className="text-[12pt] font-bold uppercase tracking-wide mb-3" style={{ color: themeColor }}>{st.summary || 'SUMMARY'}</h2>
            <Editable 
              element="p" 
              text={p.summary} 
          ...
          <section className="mb-8">
            <div className="flex items-center gap-2 group mb-3">
              <h2 className="text-[12pt] font-bold uppercase tracking-wide" style={{ color: themeColor }}>{st.experience || 'EXPERIENCE'}</h2>
                  ...
                  <ul className="space-y-1">
                    {exp.description?.map((bullet, bIdx) => (
                      <li key={bIdx} className="text-[9pt] text-slate-700 flex items-start gap-2 group/bullet">
                        <span className="mt-1 w-1 h-1 rounded-full flex-shrink-0" style={{ backgroundColor: themeColor }}></span>
        ...
        <div className="w-56">
          ...
          <section className="mb-8">
            <div className="flex items-center gap-2 group mb-3">
              <h2 className="text-[12pt] font-bold uppercase tracking-wide" style={{ color: themeColor }}>{st.skills || 'SKILLS'}</h2>
          ...
          <section>
            <div className="flex items-center gap-2 group mb-3">
              <h2 className="text-[12pt] font-bold uppercase tracking-wide" style={{ color: themeColor }}>{st.education || 'EDUCATION'}</h2>
